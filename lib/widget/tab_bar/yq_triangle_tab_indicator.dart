...
///自定义底部
class YQTriangleTabIndicator extends Decoration {
  final Size triangleSize;

  YQTriangleTabIndicator(this.triangleSize);

  @override
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    return _YQTriangleBoxPainter(this.triangleSize);
  }
}

class _YQTriangleBoxPainter extends BoxPainter {
  final Size triangleSize;

  _YQTriangleBoxPainter(this.triangleSize);
