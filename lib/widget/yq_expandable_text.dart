...
import 'package:yqcommon/res/yq_colors.dart';

typedef YQTextExpandedCallback = Function(bool);
...
class YQExpandableText extends StatefulWidget {
  ...
  /// 展开或者收起的时候的回调
  final YQTextExpandedCallback? onExpanded;

  /// 更多按钮渐变色的初始色 默认白色
  final Color? color;

  const YQExpandableText(
      {Key? key,
      required this.text,
  ...
  _YQExpandableTextState createState() => _YQExpandableTextState();
}

class _YQExpandableTextState extends State<YQExpandableText> {
