...
class PickerUtils {
  ...
  //           callback(
  //               '${_dateTime.year}-${_dateTime.month.toString().padLeft(
  //                   2, '0')}-${_dateTime.day.toString().padLeft(2, '0')}');
  //         }
  //       },
  //       onCancel: onCancel);
  // }
  ...
  //  * 多选
  //  */
  // static Future<void> showMultiLinkPicker(BuildContext context, var data,
  //     var selectData, var columeNum,
  //     {var label, MultipleCallback? callback}) async {
  //   Map mData = Map();
  //   if (data is PickerType) {
