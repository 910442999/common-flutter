...
// 单例模式
final YQAudioPlayerUtil audioPlayerUtil = YQAudioPlayerUtil();
...
/// @date 2021/12/31
///
class YQAudioPlayerUtil {
  late AudioPlayer _audioPlayer;
  late AudioCache _audioCache;

  // 工厂方法构造函数
  factory YQAudioPlayerUtil() => _getInstance();

  // instance的getter方法，singletonManager.instance获取对象
  static YQAudioPlayerUtil get instance => _getInstance();

  // 静态变量_instance，存储唯一对象
  static YQAudioPlayerUtil _instance = YQAudioPlayerUtil.internal();

  // 获取对象
  static YQAudioPlayerUtil _getInstance() {
    if (_instance == null) {
      // 使用私有的构造方法来创建对象
      _instance = YQAudioPlayerUtil.internal();
    }
    return _instance;
  }
