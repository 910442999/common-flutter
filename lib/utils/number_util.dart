...
class NumberUtil {
  ...
  /// The parameter [fractionDigits] must be an integer satisfying: `0 <= fractionDigits <= 20`.
  static num? getNumByValueDouble(dynamic value, int fractionDigits) {
  ...
  /// The parameter [fractionDigits] must be an integer satisfying: `0 <= fractionDigits <= 20`.
  static num? getNumByValueInt(int value, int fractionDigits) {
    if (value == null) return null;
    String valueStr = value.toStringAsFixed(fractionDigits);
    return fractionDigits == 0
        ? int.tryParse(valueStr)
  ...
  static Decimal divideDecStr(String a, String b) {
    Decimal s = (Decimal.parse(a) / Decimal.parse(b)).toDecimal();
    return s;
  }
